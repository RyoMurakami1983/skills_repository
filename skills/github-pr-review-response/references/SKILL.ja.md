...
| シグナル | このスキルに入る？ | アクション |
|---|---|---|
| 新しいレビューが送信された | Yes | Step 1 を1回開始 |
| 自分に review request が来た | Yes | Step 1 を1回開始 |
| ユーザーが新規レビュー到着を共有した | Yes | 確認して Step 1 を開始 |
| PRは開いているが変化なし | No | 待機継続 |
| CIステータスだけ変わった | Maybe | 本当にレビュー対応が必要か確認 |
