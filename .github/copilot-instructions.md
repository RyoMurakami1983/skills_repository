...
1. **基礎と型**: 最小形式で最大可能性を解放する設計思想
2. **教える/広める/仕組み化**: 個人知を形式知に変換し、誰もが使える資産にする
3. **自律成長**: 自分がいなくても回る仕組みをつくり、次の挑戦へ時間を生む
...
**構造**:
- YAMLフロントマター完備（name, description, author, tags, invocable）
...
このガイドラインは、20年の製造業経験 + 30年の空手修行 + AI活用の知見を統合し、「誰もが挑戦できる基礎と型」を実現するために作成されました。
